...
export SPARK_LOCAL_IP=`192.168.1.1`
#export SPARK_MASTER_IP=`192.168.1.1`
export SPARK_MASTER_HOST=`hostname -f`
export SPARK_WORKER_DIR=/hadoop/spark/spark-worker
export SPARK_LOCAL_DIRS=/hadoop/spark/spark-worker
export SPARK_LOG_DIR=/hadoop/spark/spark-logs
